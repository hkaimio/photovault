...
public class StarRating extends JPanel {
   ...
   */
  public StarRating(int stars, float rating) {
    this(stars, rating, 0);
  }
   ...
   */
  public StarRating(int stars, float rating, int selection) {
    this.stars = stars;
    this.rating = rating;
    ...
    addMouseListener(new MouseAdapter() {
      ...
      public void mousePressed(MouseEvent event) {
        if (isEnabled()) {
          ...
          int oldSelection = StarRating.this.selection;
          StarRating.this.selection = 1 + (event.getX() / STAR_BACKGROUND_IMAGE.getWidth(null));

          for (int i = 0; i < listeners.size(); i++) {
            listeners.get(i).handleSelection(StarRating.this.selection);
          }
          StarRating.this.firePropertyChange(
                  "selection", oldSelection, StarRating.this.selection );
          repaint();
        }
      }
