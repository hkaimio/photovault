...
public class Test_HistoryExport extends PhotovaultTestCase {
    ...
    @Test
    public void testFileExport() throws InstantiationException, IllegalAccessException, IOException {
        ...
        OriginalImageDescriptor orig = new OriginalImageDescriptor( i, "image#0" );
    ...
    public void testHistoryImport() throws FileNotFoundException, IOException {
        ...
        File historyFile = new File( testDir, "testHistoryImport/export_testdb_1.pv" );
        exp.importChanges( historyFile, daoFactory );
        PhotoInfoDAO photoDao = daoFactory.getPhotoInfoDAO();
        PhotoInfo p = photoDao.findByUUID( UUID.fromString( "018185f4-c9a7-4d54-a3d5-aa0ceb6641cd"));
        assertNotNull( p );
        ...
        File historyFile2 = new File( testDir, "testHistoryImport/export_testdb_2.pv" );
        exp.importChanges( historyFile2, daoFactory );
        p = photoDao.findByUUID( UUID.fromString( "018185f4-c9a7-4d54-a3d5-aa0ceb6641cd"));
